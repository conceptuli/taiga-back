...
class UserStoryCustoAttributeViewSet(ModelCrudViewSet, BulkUpdateOrderMixin):
...
class TaskCustoAttributeViewSet(ModelCrudViewSet, BulkUpdateOrderMixin):
...
class IssueCustoAttributeViewSet(ModelCrudViewSet, BulkUpdateOrderMixin):
