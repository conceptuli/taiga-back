...
# Custom Attributes
from taiga.projects.custom_attributes.api import UserStoryCustoAttributeViewSet
from taiga.projects.custom_attributes.api import TaskCustoAttributeViewSet
from taiga.projects.custom_attributes.api import IssueCustoAttributeViewSet

router.register(r"userstory-custom-attributes", UserStoryCustoAttributeViewSet,
                base_name="userstory-custom-attributes")
router.register(r"task-custom-attributes", TaskCustoAttributeViewSet,
                base_name="task-custom-attributes")
router.register(r"issue-custom-attributes", IssueCustoAttributeViewSet,
